      ...
      <div className="modal-card">
        ...
        <section className="modal-card-body">
          <div className="card-body">
            ...
            <ModalContent card={modal?.card?.Animal} />
        ...
        <footer className="modal-card-foot">
          <div className="field is-grouped">
            <div className="control">
              <Link to={`/requests/${modal?.card?.id}`} onClick={() => { dispatch(setCard({})); dispatch(setActive()); }}><button type="button" className="button is-info">Подробнее</button></Link>
            </div>
            <div className="control">
